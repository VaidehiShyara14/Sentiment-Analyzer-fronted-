...
export default function Home() {
  ...
  const handleSingleSubmit = async () => {
    ...
    try {
      const res = await fetch("https://sentiment-analyzer-backend-s6t0.onrender.com/api/sentiment", {
        method: "POST",
        body: formData,
      })
      ...
      const expRes = await fetch("https://sentiment-analyzer-backend-s6t0.onrender.com/api/explain", {
        method: "POST",
  ...
  const handleBulkSubmit = async () => {
    ...
    try {
      const res = await fetch("https://sentiment-analyzer-backend-s6t0.onrender.com/api/bulk_sentiment", {
        method: "POST",
        body: formData,
      })
      const data = await res.json()
